...
namespace FEquipmentItemDataTableUtil
{
	...
	UPaperSprite* LoadStatePreviewSprite(const FEquipmentItemDataTableRow& EquipmentData);
	...
	UPaperSprite* CreatePreviewSprite(UObject* Outer, const FEquipmentItemDataTableRow& EquipmentData, float DefaultPixelsPerUnrealUnit = 2.56f);
}
